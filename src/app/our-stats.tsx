...
export function OurStats() {
  return (
    <section className="container mx-auto grid gap-10 px-8 py-44 lg:grid-cols-1 lg:gap-20 xl:grid-cols-2 xl:place-items-center">
      <div>
        <Typography variant="h6" color="purple" className="mb-6 font-medium" placeholder={undefined} onResize={undefined} onResizeCapture={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
          Our Stats
        </Typography>
        <Typography
      ...
      <div>
        ...
        <a
          ...
          className="mt-8 block rounded-2xl border border-gray-200 bg-gray-50 p-6 transition-shadow hover:shadow-md"
        >
